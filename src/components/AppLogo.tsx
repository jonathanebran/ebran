  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id="ebranGlow" x="-40%" y="-40%" width="180%" height="180%">
      ...
      <g
        filter="url(#ebranGlow)"
        stroke="url(#ebranGrad)"
        strokeWidth="86"
        strokeLinecap="round"
      ...
      <g opacity="0.25" stroke="#FFFFFF" strokeWidth="18" strokeLinecap="round" strokeLinejoin="round">
